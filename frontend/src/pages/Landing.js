  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-background/70 border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-head font-extrabold text-xl tracking-tight">FieldForge</span>
          </div>
      ...
      <footer className="border-t border-border py-10 px-4 sm:px-6 text-center text-sm text-muted-foreground">
        <div className="flex items-center gap-2 justify-center mb-2"><HardHat className="w-5 h-5 text-primary" /><span className="font-head font-bold">FieldForge</span></div>
